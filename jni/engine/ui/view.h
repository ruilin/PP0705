...
/*
 * transform rect to rect relative of view
 * param:(View *, Rect *, Rect *)
 */
#define view_transformRect(view, originalRect, newRect) (					\
		rect_set((newRect), (view)->rect.left + (originalRect)->left,		\
				(view)->rect.top + (originalRect)->top, 					\
